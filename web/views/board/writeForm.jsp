...
<form action="<%=request.getContextPath()%>/board/writeFormEnd" 
 	method="post">	
...
<div id="boardwrite" style="background:white;">
	<table class="boardwrite_table">
		<colgroup>
			...
			<tr>
				<th>작성자</th>
<%-- 						<%=memberLoggedIn.getUserId() %> --%>
				 <td><input type="text" name="writer" class="bowrite_in" readonly value="<%=memberLoggedIn.getUserId() %>" style="width:35%;"/></td> 
			</tr>			
			<tr>
				<th>제목</th>
				<td><input type="text" name="subject" value="" class="bowrite_in" style="width:95%;" /></td>
			</tr>		
		 <tr>
			<th>비밀글</th>
		...
		<tr>
			<th>내용</th>
			<td>			
				<textarea name="content" id="board_content" style="width:100%;height:300px;"></textarea>
			</td>
		</tr>
		</table>
		...
		<div class="boardNavigation">
				...
				<button type="submit" class="btn xet_btn medium sky" onclick="return validate();" >
				<span><i class="xi-check">등록</i></span></button>
				<a href="<%=request.getContextPath()%>/board/boardList?bn=<%=bn%>&cPage=<%=cPage%>" class="btn xet_btn medium sky">
				<span><i class="xi-arrow-left"></i>취소</span></a>
				</div>
